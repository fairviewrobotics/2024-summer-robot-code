...
public class VisionConstants {
    ...
    public static final double alignRotationP = 0.06;
...
//    public static final double FOCAL_LEN = 0.012436;
    public static final double FOCAL_LEN = 0.04;


    public static final double CAM_HEIGHT = 0.584;
